...
\begin{itemize}
	...
	\item {\bf BE3.} Sunlight is very high on the UV index
...
\begin{enumerate}[{\bf BE1.}]
	...
	\begin{itemize}
			\item[] {\bf Pre-Condition:} The user is logged in and has a valid account and is knowledgeable with the system. There is valid data flowing into the system from various IoT devices.
		\end{itemize}
		...
		{\bf Global Scenario:}
		\begin{itemize}
			\item[] {\bf Precondition:} The user is logged in and has a valid account and is knowledgeable with the system. There is valid data flowing into the system from various IoT devices.
			\item[] {\bf Main Success Scenario:}
		\end{itemize}
		\begin{enumerate}[1.]
			\item User clicks on create alert tool in the dashboard navbar.
	...
	\item Sunlight is very high on the UV index
		\begin{itemize}
			\item[] {\bf Pre-Condition:} SCEMAS is operational and is receiving sensor data. An Administrator has defined and activated an alert rule for high UV sunlight.
		\end{itemize}
		\begin{enumerate}[{\bf VP1.}]
		\item Administrator
			\begin{itemize}
	...
	\item View Dashboard
		\begin{itemize}
			\item[] {\bf Pre-Condition:} SCEMAS is online, and the user has logged in with a verified account on SCEMAS with the correct level account permissions.
		\end{itemize}
		\begin{enumerate}[{\bf VP1.}]
		\item Administrator
			\begin{itemize}
			...
			\end{itemize}
			\begin{enumerate}[1.]
				\item Administrator accesses the SCEMAS application home screen.
		...
		\item City Operator
			...
			\end{itemize}
			\begin{enumerate}[1.]
				\item Operator accesses the SCEMAS application home screen.
				\item System retrieves the user's last-used geographical area and sets it as the current geographical location.
		...
		\end{itemize}
		\begin{enumerate}[1.]
			\item External User accesses the SCEMAS application home screen.
			\item System retrieves the user's last-used geographical area and sets it as the current geographical location.
			...
			\item System closes the side panel and returns to the dashboard map.
			\item External User selects a data type (air quality, noise levels, temperature, UV levels, and humidity) from the metric toggle menu.
			\item System updates the map to display the selected data type on the real-time map with colour-coded environmental maps based on the severity levels of nearby regions.
	...
	\item Public API Request to Access Data
		...
		\item Public User
			\begin{itemize}
				\item[] {\bf Pre-Condition:} SCEMAS is online, the API portal is configured by the administrator and valid aggregated data is in the system.
				\item[] {\bf Main Success Scenario:}
			\end{itemize}
			\begin{enumerate}[1.]
		...
		{\bf Global Scenario:}
		\begin{itemize}
			\item[] {\bf Pre-Condition:} SCEMAS is online and the API portal is configured by admin. Valid aggregated data is in the system.
			\item[] {\bf Main Success Scenario:}
		\end{itemize}
		\begin{enumerate}[1.]
			\item External user sends a HTTP request to the endpoint for environmental data.
	...
	\item Checking Audit log
		\begin{itemize}
			\item[] {\bf Pre-Condition:} SCEMAS system is online and actively logging activity in the audit log, Administrator has logged into the system.
		\end{itemize}
		\begin{enumerate}[{\bf VP1.}]
		\item Administrator
			\begin{itemize}
	...
	\item User authentication
		\begin{itemize}
			\item[] {\bf Pre-Condition:} The user is knowledgeable with the system. There is valid data flowing into the system from various IoT devices.
		\end{itemize}
		\begin{enumerate}[{\bf VP1.}]
		\item Administrator
			\begin{itemize}
		...
		\item City Operator
			...
			\end{itemize}
			\begin{enumerate}[1.]
				\item User opens up the SCEMAS webapp in their browser.
