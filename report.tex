...
\begin{enumerate}[{\bf BE1.}]
	...
	\begin{itemize}
		...
		\item Administrator
			\begin{itemize}
				\item[5i.] The administrator approves the alert. 
				\item[6i.] Administrator does not approve the alert.
				\begin{itemize} 
					\item[6i.1.] Feedback box appears and admin gives feedback on alert.
					\item[6i.2.] Sends feedback back to operator.
				\end{itemize}
				\item[7i.2.] The administrator is contacted by the user about a failed alert setup.
			\end{itemize}
		\item City Operator
			\begin{itemize}
			...
			\begin{enumerate}[1.]
				...
				\item User selects relevant environmental metrics, geographic area, threshold value(s) and timeframe for this alert.
				\item User selects the alert visibility, public facing vs internal.
				\item User reviews the summary and sends it to administrator for approval.
			...
			\begin{itemize}
				...
				\item[4i.] If a public facing alert has been created the system checks if the alert is permitted within the law.
				\item[5i.] User cancels the alert configuration. \\
				\hspace{1cm}5i.1. User clicks cancel alert. \\
				\hspace{1cm}5i.2. System discards all inputs and returns user to dashboard.
				\item[6i.] Administrator does not approve the alert. \\
				\hspace{1cm}6i.1. Feedback box appears and admin gives feedback on alert. \\
				\hspace{1cm}6i.2. Sends feedback back to operator.
				\item[7i.] System fails to create alert. \\
				\hspace{1cm}7i.1. System displays error message on screen. \\
				\hspace{1cm}7i.2. System provides option to contact the administrator.
			\end{itemize}
		\item Public User \\
			N/A
		...
		\begin{enumerate}[1.]
			...
			\item Once approved the system checks if the alert is valid and saves to database.
			\item System creates the alert and display a success message on screen.
		\end{enumerate}
		\begin{itemize}
			\item[] {\bf Secondary Scenario:}
			\item[1i.] User selects the wrong tool. \\
