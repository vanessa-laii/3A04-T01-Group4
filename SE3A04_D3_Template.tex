...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ImagesD3/ClassDiagramFull.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ImagesD3/ClassDiagramLeft.png}
    \caption{\textbf{Class Diagram Left Side}}
    \label{fig:Class Diagram Left Side}
\end{figure}

\stepcounter{subfigurecount}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ImagesD3/ClassDiagramRight.png}
    \caption{\textbf{Class Diagram Right Side}}
    \label{fig:Class Diagram Right Side}
\end{figure}
% End Section
