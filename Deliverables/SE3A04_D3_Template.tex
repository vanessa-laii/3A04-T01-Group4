...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ImagesD3/State_Alert_Management.png}
    \caption{\textbf{Alert Management State Diagram}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{ImagesD3/State Account Management.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{ImagesD3/State_Public_Controller.png}
    \caption{\textbf{Public Controller State Diagram}}
    \label{fig:Public Controller State Diagram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ImagesD3/ClassDiagram_updated.png}
    \caption{\textbf{Class Diagram}}
    \label{fig:Class Diagram}
\end{figure}

The enlarged Class Diagram can be seen more clearly in Figures 13.1 and 13.2

\renewcommand{\thefigure}{13.\arabic{subfigurecount}}
\newcounter{subfigurecount}

\setcounter{subfigurecount}{1}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ImagesD3/ClassDiagram_updated_top.png}
    \caption{\textbf{Class Diagram Top}}
    \label{fig:Class Diagram Top}
\end{figure}

\stepcounter{subfigurecount}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ImagesD3/ClassDiagram_updated_bottom.png}
    \caption{\textbf{Class Diagram Bottom}}
    \label{fig:Class Diagram Bottom}
\end{figure}
% End Section
...
Buehlmann, Lukas
\begin{itemize}
\item Wrote section 1.2, 1.3
\item Section 2: Alert Management State Diagram
\item Section 3: BE3 Sequence Diagram
\item Section 4: City and Public agents in the class diagram
\item Edited and added missing diagrams to LaTeX document
\end{itemize}
